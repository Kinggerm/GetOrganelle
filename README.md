...
My script was written in python 2.7.*. No special python packages need to be installed. You need no third-party software to run it successfully to get organelle reads.
